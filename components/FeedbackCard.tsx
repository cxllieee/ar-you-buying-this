    ...
    <div className="fixed bottom-0 left-0 w-full z-50 flex justify-center pointer-events-none">
      <div className="w-full max-w-md mx-auto pointer-events-auto">
        <div className="flex justify-center">
          <button
            className="w-full px-4 py-3 bg-gradient-to-r from-purple-400 via-blue-400 to-pink-400 text-white font-semibold text-center rounded-t-lg shadow-lg focus:outline-none flex items-center justify-center gap-2"
            onClick={() => setOpen(!open)}
            aria-expanded={open}
            aria-controls="feedback-content"
          >
            <span className="mx-auto">Share your feedback on AR shopping</span>
